        ...
        <div class="page-banner ovbl-dark" style="background-image:url(assets/images/banner/banner2.jpg);">
            <div class="container">
                <div class="page-banner-entry">
                    <h1 class="text-white">Details Formations </h1>
				 </div>
            </div>
        </div>
		<!-- Breadcrumb row -->
						...
						<div class="col-lg-3 col-md-4 col-sm-12 m-b30">
							<div class="course-detail-bx">
								...
								<div class="course-buy-now text-center">
									<a href="#" class="btn radius-xl text-uppercase"> Achetez ce cours maintenant </a>
								</div>
								...
								<div class="cours-more-info">
									...
									<div class="price categories">
										...
										<h5 class="text-primary"> Entrepreneur </h5>
									</div>
								</div>
								...
								<div class="row">
									<div class="col-md-12 col-lg-4">
										<ul class="course-features">
											...
											<li><i class="ti-time"></i> <span class="label">Durée</span> <span class="value">60 hours</span></li>
											<li><i class="ti-stats-up"></i> <span class="label"> Difficultes </span> <span class="value">Beginner</span></li>
											<li><i class="ti-smallcap"></i> <span class="label">La Langues</span> <span class="value">Française</span></li>
										</ul>
									</div>
